...
from whctools.views_staff.acl_tools import (
    get_acl_actions_after_date,
    get_mains_and_alts_sorted,
)
...
def list_acl_members(request, acl_pk=""):
    ...
    if request.method == "POST":
        date_selected, parsed_acl_history = get_acl_actions_after_date(request, acl_pk)

    alphabetical_mains = get_mains_and_alts_sorted(acl_obj)
